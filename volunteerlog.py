...
class VolunteerDisplay:
    ...
    def something(self):
        """This function will destroy the volunteer screen, and
        declare a class instance of the allobjects() class, sending
        it any volunteer info needed.
        """
        print("Hullo, World!")
        

    def addNewVol(self):
        """This function allows a user to input a new volunteer.
        """
    ...
    def clearAll(self):
        ...
        allwid = [self.blanklab1, self.blanklab2, self.blanklab3,
                  ...
                  self.activate, self.deactivate, self.savech, self.backb]
        for wid in allwid:
            wid.grid_forget()
    ...
    #Login Display Button Functions
    ...
    def viewf(self):
        self.viewDisplay()
        self.fillViewDisplay() 
        #grid "viewing" instructive labels
        #ungrid unnecessary widgets, retrieve id...
        return
