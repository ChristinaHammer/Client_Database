...
class allobjects:
    ...
    def __init__(self):
        ...
        self.avallabel = Label(self.gridframe, textvariable=self.agev,
                               font=('Helvetica',12),bg=self.bgcolor)\
                               .grid(row=4,column=6, rowspan=2, sticky=E)
       ...
       # self.viblank = Label(self.gridframe, text='   ',font=('Helvetica',10),
        ...
        #visit notes
        self.notv = StringVar()
        self.something = "hullo!"
        self.notescv = Text(self.gridframe, state='disabled', width=40, height=4, bd=4, font='Helvetica')
        self.notescv.insert('1.0', self.something)
        ...
        self.newVisit = Button(self.gridframe, text='New Visit', width=15,
            ...
            #this visit will clear Notes, and add date field instead of listbox.
            #buttons to display: save, cancel
            #pre-fill visitor name and volunteer name
        ...
        self.editVisit = Button(self.gridframe, text='Edit Visit', width=15,
            ...
            #this button will remove 'readonly' state from notes, and add
            #save/cancel buttons instead.
        self.editVisit.grid(row=9, column=8, sticky=W)

        self.deleteVisit = Button(self.gridframe, text='Delete Visit', width=15)
            #this button will ask user to confirm visit removal, and, if so,
            #delete the visit
        ...
        self.cancelVisit = Button(self.gridframe, text='Cancel', width=15)
            #this button will cancel a visit.
        ...
        self.dverilabel = Label(self.gridframe, text='Last Verified: ',
                              font=('Helvetica',12),bg=self.bgcolor)\
                              .grid(row=19,column=7, rowspan=2, sticky=E)
        self.mvv = StringVar()
        self.dvv = StringVar()
        self.yvv = StringVar()
        ...
        self.mov.grid(row=19, column=8, rowspan=2, sticky=E, padx=10)
        #self.vLab1.grid(row=19, column=9, rowspan=2)
        self.dov.grid(row=19, column=9, columnspan=2, rowspan=2, padx=10, sticky=W)
        #self.vLab2.grid(row=19, column=13, rowspan=2)
        self.yov.grid(row=19, column=9, rowspan=2, padx=10, sticky=E)
        ...
        #self.adultsLabel.grid(row=21,column=3,sticky=W, pady=10)
        #self.childrenLabel = Label(self.gridframe, text='Children: ',
         #                          bg=self.bgcolor,font=('Helvetica',12))
        #self.childrenLabel.grid(row=21,column=4,sticky=W)
        #self.seniorsLabel = Label(self.gridframe, text='Seniors: ',
         #                         bg=self.bgcolor,font=('Helvetica',12))
        #self.seniorsLabel.grid(row=21,column=5,sticky=W)
        #self.infantsLabel = Label(self.gridframe, text='Infants: ',
         #                         bg=self.bgcolor,font=('Helvetica',12))
        #self.infantsLabel.grid(row=21,column=6,sticky=W)
        #self.totalLabel = Label(self.gridframe, text='Total: ',
         #                       bg=self.bgcolor,font=('Helvetica',12))
        #self.totalLabel.grid(row=21,column=7,sticky=W)
        ...
        self.houseSep.grid(row=22,column=3,columnspan=40,sticky=EW)
        self.housetitle = Label(self.gridframe,text='Household Members',
                                font=("Helvetica", 16),fg='white',bg='gray10')
        self.housetitle.grid(row=22,column=3,columnspan=12, sticky=W)  
        ...
        #self.sizing = ttk.Sizegrip(self.ciGui)
        #self.sizing.grid(column=12, row=25)

        self.ciGui.columnconfigure(1, weight=2)
        #Sets some sizing stuff
        for i in range(0, 10):
            self.ciGui.columnconfigure(i, weight=1, minsize=8)

        for i in range(0, 30):
            self.ciGui.rowconfigure(i, weight=1, minsize=8)
    ...
    def newClientDisplay(self):
	    ...
	    #grid widgets
        self.addhhsep.grid(row=21,column=3,columnspan=40,sticky=EW, pady=10)
        self.addhhtitle.grid(row=21,column=3,columnspan=12, sticky=W, pady=10)
    ...
    def displayHouseholdInfo(self, info, *args):
       ...
       self.dispad.grid(row=21,column=3,sticky=W, pady=10)
       self.dischil.grid(row=21,column=4,sticky=W)
       self.dissen.grid(row=21,column=5,sticky=W)
       self.disinf.grid(row=21,column=6,sticky=W)
       self.distot.grid(row=21,column=7,sticky=W)
       return
    ...
    def familyEntryBoxes(self, *args):
       ...
       self.famfn.grid(row=21,column=3)
       self.famln.grid(row=21,column=4)
       self.famdob.grid(row=21,column=5)
       self.famphone.grid(row=21,column=8)
       self.fammon.grid(row=23,column=5,sticky=S)
       self.famday.grid(row=23,column=6,sticky=S)
       self.famyear.grid(row=23,column=7,sticky=S)
    ...
    def addMemberEntryBoxes(self, *args):
       ...
       self.clearFamily()
       #add instructive labels to grid
       self.famfn.grid(row=23,column=6, sticky=NE)
       self.famln.grid(row=23,column=8, sticky=NE)
       self.famdob.grid(row=24,column=6)
       self.famphone.grid(row=25,column=6)

       #create entry boxes, grid them, and append them to a list
       #first name 
       self.fname = Entry(self.gridframe)
       self.fname.grid(row=23, column=7, sticky=W)
       self.memDict["first"]=[self.fname]

       #last name
       self.lname = Entry(self.gridframe)
       self.lname.grid(row=23, column=9, sticky=W)
    ...
    def clearVisits(self):
        ...
        self.volv.set("")
        self.notv.set("")
        self.notescv.insert("1.0", str(self.notv))
        ...
        visitob = [self.visit_listbox, self.visit_scroll, self.visitdate,
                   ...
                   self.saveVisit, self.cancelVisit]
        for ob in visitob:
            ob.grid_forget()
