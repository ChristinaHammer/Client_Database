...
class allobjects:
    ...
    def __init__(self, volunteerID, volunteerName):
       ...
       # self.viblank = Label(self.gridframe, text='   ',font=('Helvetica',10),
        ...
        #SET TO READONLY!!!
        self.volv = IntVar()
        #self.volv.set(volunteerID)
        #self.volname = StringVar()
        #self.volname.set(volunteerName)
        ...
        """
        self.updateDisplay = [self.dispad,
        ...
        self.alllabs = [self.cslabel, self.csblank, self.cilabel, self.ciblank
                        self.fnlabel, self.lnlabel, self.phlabel,
                        self.doblabel, self.avallabel, self.djlabel,
                        self.vilabel, self.datelab, self.notelab, self.vislab,
                        self.vollab, self.blankLab2, self.hilabel,
                        self.hiblank, self.adlab, self.aplab, self.cilab,
                        self.stlab, self.zilab, self.dverilabel,
                        self.blankLab5,self.blankLab6, self.dispad,
                        self.dischil, self.dissen, self.disinf, self.distot,
                        self.housetitle, self.addhhtitle, self.entNum,
                        self.famname, self.famfn, self.famln, self.famdob,
                        self.famphone, self.fammon, self.famday, self.famyear]
        """
    ...
    def logoff(self):
        ...
        quit_session()
        self.ciGui.destroy()
        vo = volunteerlog.VolunteerDisplay()
        return
    ...
    def getVisitInput(self):
        ...
        visitInfo = visitData(Vol_ID=self.volID, visitDate=vdate, notes=vnote)
        return visitInfo
